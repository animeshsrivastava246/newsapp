...
export class News extends Component {
    ...
    async componentDidMount(){
        ...
        let data = await fetch(`https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=c5849d23c67441a8bcbc80e68c20d1b7&page=1&pageSize=${this.props.pgSize}`);
    ...
    handlePrevClick = async ()=>{
        this.setState({loading: true})
        let data = await fetch(`https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=c5849d23c67441a8bcbc80e68c20d1b7&page=${this.state.page - 1}&pageSize=${this.props.pgSize}`);
        let parsedData = await data.json();
        this.setState({
    ...
    render() {
        return (
            <div className="container my-3">
                <h2 className="text-center" style={{margin: '30px 0px'}}><strong><i>NewsPaper - Top Headlines</i></strong></h2>
